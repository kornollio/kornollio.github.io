<?php
    ...
    $to             = 'for@privetandrey.ru'; //put your email here
    $email_template = 'simple.html';  // will find it on email-templates/ directory

    $subject    = "privetandrey.ru заполненная форма";
    ...
    if ( mail( $to, $subject, $contents, $headers ) ) {
        $result = array( 'response' => 'success', 'message'=>'<strong>Отлично!</strong> Спасибо за письмо' );
    } else {
        $result = array( 'response' => 'error', 'message'=>'<strong>Упс!</strong> Что-то заполнено неправильно, лучше проверить'  );
    }
